...
Утиліта `openssl` (Open Secure Sockets Layer) — це багатофункціональний криптографічний інструмент командного рядка. Вона використовується для широкого спектра завдань, пов'язаних із протоколами SSL/TLS, сертифікатами, шифруванням, хешуванням та іншими криптографічними операціями.
