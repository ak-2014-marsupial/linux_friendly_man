...
### 5.18. Ловушка FTP: Подмена системного FTP-сервера\n\n*   **🎯 Цель:** Перехватить учетные данные пользователей или получить несанкционированный доступ к файлам при попытке подключения к FTP-серверу.
