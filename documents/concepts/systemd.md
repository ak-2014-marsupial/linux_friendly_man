...
| **Складність конфігурації** | Скрипти були написані мовою Shell, що вимагало знання складних інструкцій і було схильне до помилок. ([Див. приклад](#6-додаток-приклад-init-скрипта-в-sysvinit)) |
