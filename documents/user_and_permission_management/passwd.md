Команда `passwd` використовується для керування паролями користувачів. Вона дозволяє як змінювати власний пароль, так і встановлювати або змінювати паролі інших користувачів (з правами суперкористувача).
